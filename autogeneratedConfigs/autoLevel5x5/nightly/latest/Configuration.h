...
#define STRING_CONFIG_H_AUTHOR "(Dust, valerionew, Ender-3 Pro, risapav)" //ORIGINAL: #define STRING_CONFIG_H_AUTHOR "(Dust, Ender-3 Pro)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -10, 0 } //ORIGINAL: #define NOZZLE_TO_PROBE_OFFSET { 10, 10, 0 }
